 ...
 * @author clecio
 * @see
 * <a href="http://stackoverflow.com/questions/3531506/using-public-key-from-authorized-keys-with-java-security">using-public-key-from-authorized-keys-with-java-security(stackoverflow)</a>
 */
